...
//        Log.e("testest", String.valueOf(dstRect.left) + " " + String.valueOf(dstRect.right)
//                + " " + String.valueOf(dstRect.top) + " " + String.valueOf(dstRect.bottom));
    ...
    private int loadPage(final int userPage, final int nbOfPartsLoadable) {
        ...
        class SpiralLoopListenerImpl implements SpiralLoopManager.SpiralLoopListener {
            ...
            public boolean onLoop(int row, int col) {
                ...
                //Log.e("testrender", "befor " + String.valueOf(relX) + " " + String.valueOf(relWidth) + " " + String.valueOf(relY) + " " + String.valueOf(relHeight));
                if (relX + relWidth > 1) {
                    relWidth = 1 - relX;
                }
                if (relY + relHeight > 1) {
                ...
                if (renderWidth != 0 && renderHeight != 0) {
                    //Log.e("testrender", "after " + String.valueOf(relX) + " " + String.valueOf(relWidth) + " " + String.valueOf(relY) + " " + String.valueOf(relHeight));
                    //Log.e("testrender", String.valueOf(pageRelativeBounds.left) + " " + String.valueOf(pageRelativeBounds.right));
                ...
                nbItemTreated++;
                //Log.e("testrender", String.valueOf(nbItemTreated) + " " + String.valueOf(nbOfPartsLoadable));
    ...
    public void loadComplete(DecodeService decodeService) {
        ...
        Log.i(TAG, pageWidth + "pdfwidth " + pageHeight + "pageHeight");
        state = State.LOADED;
        calculateOptimalWidthAndHeight();
...
//        }
        ...
        h = h * width / w;
        w = width;
        //Log.e("testscreen", String.valueOf(width) + " " + String.valueOf(height));

        optimalPageWidth = w;
        optimalPageHeight = h;

        Log.i("PDFVIEW", "pdfwidth============" + optimalPageWidth);
        Log.i("PDFVIEW", "pdfheight============" + optimalPageHeight);
...
//            File pdfFile = FileUtils.fileFromAsset(getContext(), assetName);
            File pdfFile = new File(assetName);
