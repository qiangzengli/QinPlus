...
public class MidiNote implements Comparator<MidiNote> {
    ...
    boolean m_bParentheses;//升音降音有没有括�?
...
//    Note noteSelfNote;
    ...
    public boolean m_bPedalStart;    //踏板�?始标�?
    public boolean m_bPedalStop;    //踏板结束标志

    public int m_nFermata;    //延音记号 1 �?  2�?
    public int m_nMordentDirection;    //下波�? 1�? 2�?
    public int m_nInvertedMordentDirection;    //上波�? 1�? 2�?
    public int m_nTurnDirection;    //回音 1�? 2�?

    public int m_nTempoDirection;
    public boolean m_bTempoParentheses;        //是否有括�?
    public int m_nBeatUnit;                //节拍单元
    public int m_nPerMinute;            //�?分钟几个�?

    public boolean m_bTrillMark;    //颤音标记
//	public Wavyline m_pWavyline;//波浪�?

//	public OctaveShift m_octaveShift;	//八度�?
...
//    }
     ...
     */
//    public MidiNote(Note notecell, int starttime, int channel, int notenumber, int duration, MidiNote noteGrace,
//    					boolean bFlagHasNoteGrace,int nTupletNormalType, int starttimemidi, int durationMidi)
//    {
//    	this.noteSelfNote = notecell;
//        this.starttime = starttime;
//        this.channel = channel;
//        this.notenumber = notenumber;
//        this.duration = duration;
...
//		this.m_nMordentDirection = notecell.m_nMordentDirection;	//下波�?
//		this.m_nInvertedMordentDirection = notecell.m_nInvertedMordentDirection;	//上波�?
//		this.m_nTurnDirection = notecell.m_nTurnDirection;
//		this.m_bTempoParentheses = notecell.m_bTempoParentheses;	 	//是否有括�?
//		this.m_nBeatUnit = notecell.m_nBeatUnit;				//节拍单元
//		this.m_nPerMinute = notecell.m_nPerMinute;			//�?分钟几个�?
...
//    }
    ...
    public int getStartTimeMidi() {
        return starttimeMidi;
    }

    public void setStartTimeMidi(int value) {
        starttimeMidi = value;
    }

    public int getDurationMidi() {
        return durationMidi;
    }

    public void setDurationMidi(int value) {
        durationMidi = value;
    }

    public int getEndTimeMidi() {
        return starttimeMidi + durationMidi;
    }
