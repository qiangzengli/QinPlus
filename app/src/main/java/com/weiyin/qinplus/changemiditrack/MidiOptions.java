...
public class MidiOptions implements Serializable {
     ...
     * Display the piano
     */
    public boolean[] tracks;//轨道
    /**
     * Which tracks to display (true = display)
     */
    public int[] instruments; //乐器
    /**
     * Which instruments to use per track
     */
    public boolean useDefaultInstruments; //默认乐器
    /**
     ...
     */
    public boolean bFlagSmartPlay;        // 智能感知按键
    public boolean bFlagMe;            // 节拍�?
    public boolean bFlagStep;            // 步进
    public int iAccomVolumn;            // 伴奏音量
    public int iMainVolumn;                // 主音�?
    ...
    public String toJson() {
        try {
            ...
            json.put("HandType", HandType);//add
    ...
    public static MidiOptions fromJson(String jsonString) {
        ...
        try {
            ...
            options.HandType = json.getInt("HandType");
        } catch (Exception e) {
            return null;
        }
        return options;
    ...
    public MidiOptions copy() {
        ...
        options.HandType = HandType;//add

        return options;
    }

    public void setHandType(int handType2) {
