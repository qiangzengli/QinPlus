...
public class BluetoothDialogMain extends Dialog implements InterfaceBlueConnect, View.OnClickListener {
    ...
    public BluetoothDialogMain(Activity context) {
        super(context);
        this.mContext = context;
    }

    public BluetoothDialogMain(Activity context, int themeResId) {
        super(context, themeResId);
        this.mContext = context;
    }

    protected BluetoothDialogMain(Activity context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    public void onClick(View v) {
        if (v.getId()==R.id.bluetooth_textview_status) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bluetoothlistdialog_main_layout);
        LayoutHelper layoutHelper = new LayoutHelper(mContext);
        layoutHelper.scaleView(findViewById(R.id.bluetoothlistdialog_main_layout));
...
//            mBluetoothAdapterBle.stopLeScan(mLeScanCallback);
    ...
    private class LeDeviceListAdapter extends RecyclerView.Adapter<LeDeviceListAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(mContext).inflate(R.layout.item_bluetooth_main_recycler, null);
