...
import com.weiyin.qinplus.ui.tv.utils.GenerateViewId;
import com.weiyin.qinplus.ui.tv.utils.OPENLOG;
...
//                lv.setSelector(R.drawable.nocolor);
    ...
    private IOpenMenuItem getAdapterOpenMenuItem(AdapterView<?> parent, int position) {
        ...
        MenuAdpater menuAdpater = (MenuAdpater) parent.getAdapter();
        if (menuAdpater != null) {
            IOpenMenu openMenu = menuAdpater.getOpenMenu();
            if (openMenu != null) {
