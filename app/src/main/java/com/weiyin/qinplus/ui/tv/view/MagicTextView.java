...
public class MagicTextView extends TextView {
	...
	public void init(AttributeSet attrs){
		...
		if(attrs != null){
			...
			if(a.hasValue(R.styleable.MagicTextView_magictextbackground)){
				Drawable background = a.getDrawable(R.styleable.MagicTextView_magictextbackground);
				if(background != null){
					this.setBackgroundDrawable(background);
				}else{
					this.setBackgroundColor(a.getColor(R.styleable.MagicTextView_magictextbackground, 0xff000000));
				}
			}
	...
	// Keep these things locked while onDrawKeyBoard in processing
	public void freeze(){
