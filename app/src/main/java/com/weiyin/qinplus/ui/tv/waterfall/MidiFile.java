...
public class  MidiFile {
	...
	static int iMeasureStartIndex;//measure��ʲô��ʼ����
	static int iQuarterOne;
    ...
    public ArrayList<MidiEvent> mergeMidiEvents()
    {
...
//        File filetest = new File("/mnt/sdcard/小汤8-16-圆舞曲.mid");//小汤8-16-圆舞曲
...
/*            Log.e(TAG,  "offset " + startoffset + 
    ...
    public ArrayList<MidiTrack> ChangeMidiNotes(MidiOptions options) {
        ...
        //Torres Mark 由于不是标准的midi，暂时屏蔽，不然虚拟键左右手有问题
