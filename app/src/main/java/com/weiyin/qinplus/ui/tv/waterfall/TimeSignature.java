...
public class TimeSignature implements Serializable {
    ...
    public void setDenminator(int number) {
		denominator = number;
	}
    ...
    public NoteDuration GetNoteDurationRest(int duration)
    {
    	//int whole = quarternote * numerator * 4 / denominator;
    	int whole = quarternote * 4;
    	if(duration == quarternote * numerator * 4 / denominator)
